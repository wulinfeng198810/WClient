 ...
 *  SDK setting options
 */
@property (nonatomic, strong, readonly) LTOptions *options;
 ...
 *  Apple APNS setting
 */
//@property (nonatomic, strong, readonly) LTPushOptions *pushOptions;
 ...
 *  Chat module
 */
@property (nonatomic, strong, readonly) id<LTChatManager> chatManager;
 ...
 *  Contact module
 */
//@property (nonatomic, strong, readonly) id<ILTContactManager> contactManager;
 ...
 *  Group module
 */
//@property (nonatomic, strong, readonly) id<ILTGroupManager> groupManager;
 ...
 *  Chatroom module
 */
//@property (nonatomic, strong, readonly) id<ILTChatroomManager> roomManager;
 ...
 */
- (void)addDelegate:(id<LTClientDelegate>)aDelegate
 ...
 *  @param aDelegate  Delegate
 */
- (void)rLToveDelegate:(id)aDelegate;
 ...
 *  @result Error
 */
- (LTError *)initializeSDKWithOptions:(LTOptions *)aOptions;
 ...
 *  @result Error
 */
- (LTError *)registerWithUsername:(NSString *)aUsername
 ...
 *  @result Error
 */
- (LTError *)loginWithUsername:(NSString *)aUsername
                      password:(NSString *)aPassword;
 ...
 *  @result Error
 */
- (LTError *)logout:(BOOL)aIsUnbindDeviceToken;
 ...
 *  @result Error
 */
- (LTError *)bindDeviceToken:(NSData *)aDeviceToken;
 ...
 *  @result Error
 */
- (LTError *)setApnsNickname:(NSString *)aNickname;
 ...
 *  @result Apns options
 */
//- (LTPushOptions *)getPushOptionsFromServerWithError:(LTError **)pError;
 ...
 *  @result Error
 */
- (LTError *)updatePushOptionsToServer;
...
- (void)asyncRegisterWithUsername:(NSString *)aUsername
                         password:(NSString *)aPassword
                          ...
                          failure:(void (^)(LTError *aError))aFailureBlock;
 ...
 *  @param aFailureBlock    The callback block of failure
 */
//- (void)asyncGetPushOptionsFromServer:(void (^)(LTPushOptions *aOptions))aSuccessBlock
//                              failure:(void (^)(LTError *aError))aFailureBlock;
